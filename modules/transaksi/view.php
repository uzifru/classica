          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Biaya paket</th>
                <th class="center">Tambahan Orang</th>
                <th class="center">Biaya Tambahan</th>
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='110' class='center'>$data[nama_paket]</td>
                      <td width='80' align='right'>Rp. ".format_rupiah($data['harga'])."</td>
                      <td width='80' class='center'>$data[tambahan_orang]</td>
                      <td width='80' align='right'>Rp. ".format_rupiah($data['harga_tambahan'])."</td>
                      <td width='80' align='right'>Rp. ".format_rupiah($data['total'])."</td>
